...
export const metadata: Metadata = {
  ...
  keywords: [
    'economic simulation', 'macroeconomics game', 'fiscal policy simulator',
    'trade war game', 'central bank simulator', 'economics education',
    'gdp simulator', 'inflation game', 'econoquest',
  ],
